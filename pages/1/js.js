	...
	return _Utils_Tuple2(
		{
			...
			menus: _List_fromArray(
				[
					...
					_Utils_Tuple2('github', ''),
					_Utils_Tuple2('twitter', ''),
					_Utils_Tuple2('blog', '')
				]),
			s: 'asdf',
			selectedMenu: '',
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('nes-avatar is-rounded is-large'),
														$elm$html$Html$Attributes$src('pages/1/g.png')
													]),
												_List_Nil)
											]))
									])),
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('nes-avatar is-rounded is-large'),
														$elm$html$Html$Attributes$src('pages/1/bl.png')
													]),
												_List_Nil)
											]))
									]))
